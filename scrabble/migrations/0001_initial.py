...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scrabble_userprofile', (
            ...
            ('temp_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('temp_letters', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
    ...
    models = {
        ...
        u'scrabble.userprofile': {
            ...
            'temp_letters': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'temp_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
